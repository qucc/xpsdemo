    ...
    public partial class Window1 : Window
    {
        ...
        protected override void OnKeyDown(System.Windows.Input.KeyEventArgs e)
        {
            ...
            if(e.Key == Key.D1)
            {
                ...
                _xpsDocument = new XpsDocument(xpsList[index], System.IO.FileAccess.Read);

                var paginator = _xpsDocument.GetFixedDocumentSequence().DocumentPaginator;
                Console.WriteLine("page size " + paginator.PageCount);
                Console.WriteLine("page size " + paginator.PageSize);
                var visual = paginator.GetPage(1).Visual;
